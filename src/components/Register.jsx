  ...
  return (
    <div className='login_wrape'>
        ...
        <form onSubmit={handleKey}>
            ...
            <span style={{marginTop:"10px"}}>{userEmail === "" ? <span className='span-erorr two'>Please enter your E-mail</span> : null}</span>
            ...
            <span>{userPassword === "" ? <span className='span-erorr three'>Please enter password</span>: null ||userPassword.length <= 8 ? <span className='span-erorr three'>Password must be 8 characters</span>: null  }</span>
        </form>
